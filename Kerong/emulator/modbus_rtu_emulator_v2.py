#!/usr/bin/env python3
"""
Modbus RTU Slave Emulator for Windows - Version 2
Emulates 1-10 Modbus slave devices on RS485 (half-duplex)
Enhanced with detailed error tracking and analysis
"""
...
class EmulatorGUI:
    """Windows GUI for Modbus RTU Emulator V2"""

    def __init__(self, root):
        self.root = root
        self.root.title("Modbus RTU Slave Emulator V2")
    ...
    def _create_widgets(self):
        ...
        # Statistics Frame
        stats_frame = ttk.LabelFrame(self.root, text="Statistics & Errors", padding=10)
        ...
        notebook.add(realtime_frame, text="Real-time Stats")

        self.stats_text = scrolledtext.ScrolledText(realtime_frame, height=15, width=90,
                                                     font=("Courier New", 9))
        self.stats_text.pack(fill=tk.BOTH, expand=True)

        # Error details tab (NEW!)
        error_frame = ttk.Frame(notebook)
        notebook.add(error_frame, text="Last 5 Errors")

        self.error_text = scrolledtext.ScrolledText(error_frame, height=15, width=90,
                                                     font=("Courier New", 8),
                                                     foreground="red")
    ...
    def _start_emulator(self):
        ...
        try:
            ...
            self._log(f"Emulator V2 started: {port} @ {baudrate} baud")
    ...
    def _save_statistics(self):
        ...
        filename = f"modbus_stats_v2_{timestamp}.txt"
