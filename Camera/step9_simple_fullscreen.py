#!/usr/bin/env python3
# Step 9: Simple fullscreen camera app
...
class CameraSimpleFullscreen(Gtk.Window):
    def __init__(self):
        super().__init__()
        self.set_title("Step 9: Simple Fullscreen Camera")
    ...
    def setup_layout(self):
        ...
        windowed_btn = Gtk.Button(label="Windowed")
        windowed_btn.set_size_request(100, 50)
        windowed_btn.connect("clicked", self.toggle_fullscreen)
        hbox3.pack_start(windowed_btn, False, False, 0)
    ...
    def start_camera(self):
        try:
            ...
            self.video_info.set_markup(f"<span font='16' color='blue'><b>Video playing in separate window\n{self.current_format} {w}x{h} @ {self.current_fps}fps\n\nTip: You can manually position the video window</b></span>")
