#!/usr/bin/env python3
# Step 14: Camera with FIXED rotation and more FPS options
...
class CameraFixedRotation(Gtk.Window):
    def __init__(self):
        super().__init__()
        self.set_title("Step 14: Camera with Fixed Rotation")
        ...
        # Extended FPS options including 5 and 10
    ...
    def setup_layout(self):
        ...
        controls_frame.set_size_request(800, 450)
    ...
    def start_camera(self):
        try:
            ...
            # Build pipeline based on format - ALWAYS include rotation
            if self.current_format == 'H264':
                # H.264 pipeline - always apply videoflip
                ...
                # MJPG pipeline - always apply videoflip
                ...
                # YUYV pipeline - always apply videoflip
            ...
            print(f"Rotation: {self.current_rotation}° (method={self.get_flip_method()})")
            ...
            info_text += f"Flip method: {self.get_flip_method()}</b></span>"
            self.video_info.set_markup(info_text)
    ...
    def get_flip_method(self):
        ...
        method = rotation_methods.get(self.current_rotation, 2)
        print(f"Rotation {self.current_rotation}° -> flip method {method}")
        return method
