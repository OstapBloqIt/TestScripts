#!/usr/bin/env python3
# Step 11: Camera app with simplified fullscreen toggle
...
class CameraSimpleToggle(Gtk.Window):
    def __init__(self):
        super().__init__()
        self.set_title("Step 11: Camera with Simple Toggle")

        # Track fullscreen state manually
    ...
    def setup_layout(self):
        ...
        self.fullscreen_btn.connect("clicked", self.simple_toggle_fullscreen)
    ...
    def simple_toggle_fullscreen(self, btn):
        """Simple fullscreen toggle without complex state tracking"""
        try:
