#!/usr/bin/env python3
# Step 12: Camera app without fullscreen toggle (fixed size)
...
class CameraNoFullscreen(Gtk.Window):
    def __init__(self):
        super().__init__()
        self.set_title("Step 12: Camera - Fixed Layout")

        # Fixed window size for your rotated display - no fullscreen toggle
        self.set_default_size(800, 1280)
        self.set_position(Gtk.WindowPosition.CENTER)
        self.set_resizable(False)  # Fixed size to prevent issues
    ...
    def setup_layout(self):
        ...
        self.video_info.set_markup("<span font='18'>Video will appear in separate window\n\nFixed 800x1280 layout for rotated display</span>")
    ...
    def start_camera(self):
        try:
            ...
            self.video_info.set_markup(f"<span font='18' color='blue'><b>Video playing in separate window\n{self.current_format} {w}x{h} @ {self.current_fps}fps\n\nFixed layout - no fullscreen toggle</b></span>")
